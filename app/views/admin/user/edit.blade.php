    ...
    <div class="col-md-12">
        ...
        <div class="box box-primary">
            <div class="box-header">
                <h3 class="box-title">{{ trans("name.edit") }} {{ trans("name.user-") }}</h3>
            </div><!-- /.box-header -->
            <!-- form start -->
            {{ Form::open() }}
                <div class="box-body">
                    ...
                    <div class="form-group {{ $errors->first('firstname') ? 'has-error' : '' }}">
                        ...
                        {{ Form::text('firstname', $item->firstname, ['class' => 'form-control', 'placeholder' => 'Имя']) }}
                    </div>
                    <div class="form-group {{ $errors->first('lastname') ? 'has-error' : '' }}">
                        {{ Form::label('lastname', 'Фамилия') }}
                        {{ Form::text('lastname', $item->lastname, ['class' => 'form-control', 'placeholder' => 'Фамилия']) }}
                    </div>
                    <div class="form-group {{ $errors->first('email') ? 'has-error' : '' }}">
                        {{ Form::label('email', 'Email')}}
                        {{ Form::text('email', $item->email, ['class' => 'form-control', 'placeholder' => 'Email', 'rows' => 3]) }}
                    </div>
