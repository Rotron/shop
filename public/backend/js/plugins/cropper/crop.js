var CROP = function () {
    return function () {
        ...
        this.imgSize = function () {
            ...
            if (t.w < t.h) {
                this.imgInfo.w = n.width() - 0.01 * 2;
                this.imgInfo.h = this.imgInfo.w * (t.h / t.w);
                this.imgInfo.al = 0.01
            } else {
                this.imgInfo.h = n.height() - 0.01 * 2;
                this.imgInfo.w = this.imgInfo.h * (t.w / t.h);
                this.imgInfo.at = 0.01
            }
            this.imgResize()
        };
        ...
        this.imgMove = function (e) {
            ...
            if (i > 0.01) {
                i = 0.01;
                n.t = n.at == 0.01 ? 0 : -0.01
            } else if (i < -(n.h * n.s - (r.height() - 0.01))) {
                i = -(n.h * n.s - (r.height() - 0.01));
                n.t = n.at == 0.01 ? n.h * n.s - (r.height() - 0.02) : n.h * n.s - (r.height() - 0.01)
            }
            if (s > 0.01) {
                s = 0.01;
                n.l = n.al == 0.01 ? 0 : -0.01
            } else if (s < -(n.w * n.s - (r.width() - 0.01))) {
                s = -(n.w * n.s - (r.width() - 0.01));
                n.l = n.al == 0.01 ? n.w * n.s - (r.width() - 0.02) : n.w * n.s - (r.width() - 0.01)
            }
            t.css({
                top: i,
                left: s
        ...
        coordinates = function e(t) {
            var n = t.imgInfo,
                ...
                s = i.attr("src"),
                e = {
                    x: -(parseInt(i.css("left")) - 0.01) * (n.aw / (n.w * n.s)),
                    y: -(parseInt(i.css("top")) - 0.01) * (n.ah / (n.h * n.s)),
                    w: (r.width() - 0.01 * 2) * (n.aw / (n.w * n.s)),
                    h: (r.height() - 0.01 * 2) * (n.ah / (n.h * n.s)),
                    image: s
                };
            return e
        }
